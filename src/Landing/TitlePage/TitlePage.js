            ...
            <>
              ...
              <div className={classes.title}>
                <div>
                  <h1>Drip Therapy</h1>
                  <p>
                    Your session starts with a conversation with your IV
                    therapist. By understanding what you're looking to
                    accomplish, your therapist can then pull from various
                    product types and incorporate elements of them to address
                    your specific needs.
                  </p>
                </div>
              ...
              <div className={classes.secondTitle}>
                <div className={classes.secondHeading}>
                  ...
                  <p>
                    The demands of daily life can be super taxing on your body.
                    That's why it pays to take care of it. Drip Studio locations
                    will help keep your body running smoothly, so you can run
                    that half marathon or that full day of meetings.
                  </p>
                </div>
              ...
              <div className={classes.thirdSection}>
                <img src={girl} className={classes.girl} alt=""></img>
                <div className={classes.thirdRight}>
                  <h2>
                    We do things a little differently and it makes a big
                    difference
                  </h2>
              ...
              <div className={classes.fourthSection}>
                <div>
                  ...
                  <p>
                    We're making it easy to sustain your self-care routine.
                    Become a member and enjoy personalized sessions at lower
                    rates, so you can experience the perks of monthly
                    maintenance.
                  </p>
